...
CV.gaussianBlur = function(imageSrc, imageDst, imageMean, kernelSize) {
  ...
  // Initialize `imageDst` and `imageMean` with the same dimensions and data
  imageDst.width = imageSrc.width;
  imageDst.height = imageSrc.height;
  imageDst.data = new Array(imageSrc.width * imageSrc.height).fill(0); // Correctly initialize `data`

  imageMean.width = imageSrc.width;
  imageMean.height = imageSrc.height;
  imageMean.data = new Array(imageSrc.width * imageSrc.height).fill(0); // Correctly initialize `data`
